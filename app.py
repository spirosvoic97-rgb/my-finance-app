...
# Κατηγορίες από τους πίνακές σου
INCOME_CATEGORIES = [
    "Άλλα Έσοδα / Έκτακτα", 
    "Ιδιαίτερα", 
...
if not df.empty:
    ...
    fig.update_layout(title="Ανάλυση Εσόδων - Εξόδων & Καθαρού Αποτελέσματος", showlegend=False)
